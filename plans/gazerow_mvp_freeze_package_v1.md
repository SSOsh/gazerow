...
| --- | --- | --- |
| Finder | Limited | sidebar row candidate 수집 보강 후 fixed task 재평가 |
| Safari | Evaluation pass | toolbar button task pass |
| Chrome | Evaluation pass | address bar focus task pass |
| VS Code | Limited | Activity Bar candidate 수집 보강 후 fixed task 재평가 |
...
Required fixes before freeze: `gazerow_internal_user_evaluation_v1.md` 기준 내부 사용자 3명 평가
