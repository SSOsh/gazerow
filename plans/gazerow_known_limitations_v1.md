...
| 8 | Discord는 현재 Post-MVP smoke에서 clickable candidate가 0개다 | target window resolve는 됐지만 scanner 결과가 `no_candidates` |
...
| Discord | Unsupported: no clickable candidates in current smoke |
| Obsidian | Unverified |
