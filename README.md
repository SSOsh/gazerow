...
> Safari/Chrome/System Settings pass, Finder/VS Code fail이며, 현재 차단
> 항목은 30분 crash-free session과 내부 사용자 3명 평가다.
...
| TICKET-010 | In progress | runtime wiring, 권한 요청 동선, Accessibility 권한 부여, 5개 앱 overlay activation smoke 및 실제 click task 완료. 3 pass / 2 fail, 30분 session과 내부 사용자 평가는 미완료 |
...
- TICKET-010 30분 crash-free session과 내부 사용자 3명 평가
