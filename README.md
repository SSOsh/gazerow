...
> overlay activation smoke는 통과했으며, 현재 차단 항목은 실제 click task,
> 30분 crash-free session, 내부 사용자 3명 평가다.
...
| TICKET-010 | In progress | runtime wiring, 권한 요청 동선, Accessibility 권한 부여, 5개 앱 overlay activation smoke 완료. 실제 click task 수동 평가는 미완료 |
