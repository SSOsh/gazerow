...
> runtime wiring 차단은 해소했다. Settings에서 Accessibility 요청 버튼까지
> 연결했으며, 현재 차단 항목은 로컬 Accessibility 권한 부여다. 권한 부여 후
...
| TICKET-010 | Blocked by Accessibility permission | runtime wiring 및 Settings 권한 요청 버튼 완료. 권한 precheck에서 Accessibility not granted 확인, 권한 부여 후 5개 앱 수동 평가 재시도 |
