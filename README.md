...
> Finder/VS Code overlay 표시 smoke를 통과했다. 내부 사용자 3명 gate는 ED-008에
...
| TICKET-010 | In progress | runtime wiring, 권한 요청 동선, Accessibility 권한 부여, 5개 앱 overlay activation smoke, 실제 click task, 30분 crash-free session, click result stdout reporter, overlay 좌표 보정 및 Finder/VS Code 표시 smoke 완료. 내부 사용자 gate는 Post-MVP defer. Finder/VS Code fixed task 재평가는 미완료 |
